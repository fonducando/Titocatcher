...
public class Tito_Catcher extends PApplet {
...
public boolean CheckEngineerHover()
{
 ...
 public boolean CheckStartButtonHover()
{
...
public void mouseClicked()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Tito_Catcher" };
    if (passedArgs != null) {
